    ...
    <>
      ...
      <section className="page">
        ...
        <div className="intro-grid">
          ...
          <article className="intro-card"><div className="number">03</div><h3>Edit before saving</h3><p>Replace, remove and reorder ideas. Sign-in is offered only when the plan has value.</p></article>
        </div>
      </section>
...
export function HelpPage() {
  return (
    <div className="narrow-page legal-copy">
      ...
      <h2>Why do I need an email to save?</h2>
      <p>In connected mode, a secure one-time link identifies your account without a password. You can build and edit the first plan without registering. Demo mode can store a clearly labelled local copy in this browser.</p>
      <h2>How do I delete my trip?</h2>
      <p>Open My trip or the saved plan and use Delete trip. Connected deletion is protected by account-level database rules.</p>
...
export function PrivacyPage() {
  return (
    <div className="narrow-page legal-copy">
      ...
      <p>If you choose to save after signing in, Supabase stores your account identifier, structured brief and validated itinerary. A retention period must be approved and published before a live pilot accepts real visitors.</p>
      <h2>Measurement</h2>
